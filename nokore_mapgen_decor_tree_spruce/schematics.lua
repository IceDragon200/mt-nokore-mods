...
local Y = {name = "nokore_world_tree_spruce:spruce_log", prob = 255, force_place = true}
local L = {name = "nokore_world_tree_spruce:spruce_leaves", prob = 255}
local l = {name = "nokore_world_tree_spruce:spruce_leaves", prob = 233}
