...
mod:register_node("spruce_leaves", {
  description = mod.S("Spruce Leaves"),
    ...
    items = {
      {
        ...
        items = {"nokore_world_tree_spruce:spruce_sapling"},
        rarity = 20,
      },
      {
        -- player will get leaves only if they get no saplings,
        -- this is because max_items is 1
        items = {"nokore_world_tree_spruce:spruce_leaves"},
      }
    }
  },
